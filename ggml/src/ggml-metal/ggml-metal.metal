...
#define NS20 (FC_flash_attn_ext_ns20)
  ...
  //constexpr short PV16 = PV/16;
    ...
    constexpr short NW  = N_SIMDWIDTH;
    static_assert(Q % 8 == 0, "Q must be divisible by 8");
    constexpr short QB  = Q/8;
        ...
        for (int ic0 = 0; ; ++ic0) {
            ...
            if (is_same<kd4x4_t, k4x4_t>::value) {
                ...
                FOR_UNROLL (short cc = 0; cc < NC; ++cc) {
                    FOR_UNROLL (short qb = 0; qb < QB; ++qb) {
                        qk8x8_t mqk = make_filled_simdgroup_matrix<qk_t, 8>((qk_t) 0.0f);
                        threadgroup const q_t * pq = sq + qb*8*DK;
                        threadgroup       s_t * ps = ss + qb*8*SH + sgitg*(8*1) + cc*(8*NSG);
...

                        {
                            ...
                            if (DV <= 64) {
                                FOR_UNROLL (short cc = 0; cc < C/8; ++cc) {
                                    s8x8_t vs;
                                    simdgroup_load(vs, ss + qb*8*SH + 8*cc, SH, 0, false);
                                ...
                                FOR_UNROLL (short cc = 0; cc < NC; ++cc) {
                                    ...
                                    simdgroup_load(vs[0], ss + qb*8*SH + 16*cc + 0, SH, 0, false);
                                    simdgroup_load(vs[1], ss + qb*8*SH + 16*cc + 8, SH, 0, false);
...
// f16 Q variant: reads queries as half4 from device memory to reduce Q bandwidth
#define FA_TYPES_F16Q \
    half,   half4,     simdgroup_half8x8,  \
    half4,                                 \
    half,   half4x4,   simdgroup_half8x8,  \
    half,   half4x4,   simdgroup_half8x8,  \
...
typedef decltype(kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16, 64, 64>) flash_attn_ext_f16q_t;

template [[host_name("kernel_flash_attn_ext_f16_dk32_dv32_f16q"  )]]  kernel flash_attn_ext_f16q_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  32,  32>;
template [[host_name("kernel_flash_attn_ext_f16_dk40_dv40_f16q"  )]]  kernel flash_attn_ext_f16q_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  40,  40>;
template [[host_name("kernel_flash_attn_ext_f16_dk48_dv48_f16q"  )]]  kernel flash_attn_ext_f16q_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  48,  48>;
template [[host_name("kernel_flash_attn_ext_f16_dk64_dv64_f16q"  )]]  kernel flash_attn_ext_f16q_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  64,  64>;
template [[host_name("kernel_flash_attn_ext_f16_dk72_dv72_f16q"  )]]  kernel flash_attn_ext_f16q_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  72,  72>;
template [[host_name("kernel_flash_attn_ext_f16_dk80_dv80_f16q"  )]]  kernel flash_attn_ext_f16q_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  80,  80>;
template [[host_name("kernel_flash_attn_ext_f16_dk96_dv96_f16q"  )]]  kernel flash_attn_ext_f16q_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  96,  96>;
template [[host_name("kernel_flash_attn_ext_f16_dk112_dv112_f16q")]]  kernel flash_attn_ext_f16q_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  112, 112>;
template [[host_name("kernel_flash_attn_ext_f16_dk128_dv128_f16q")]]  kernel flash_attn_ext_f16q_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  128, 128>;

// tile-16 instantiations: process 16 queries per threadgroup (Q=16) to halve threadgroup count
// f32 Q + f16 KV, tile-16
typedef decltype(kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16, 64, 64, OP_FLASH_ATTN_EXT_NQPSG_16>) flash_attn_ext_t16_t;

template [[host_name("kernel_flash_attn_ext_f16_dk32_dv32_t16"  )]]  kernel flash_attn_ext_t16_t kernel_flash_attn_ext<FA_TYPES,    half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  32,  32, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk40_dv40_t16"  )]]  kernel flash_attn_ext_t16_t kernel_flash_attn_ext<FA_TYPES,    half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  40,  40, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk48_dv48_t16"  )]]  kernel flash_attn_ext_t16_t kernel_flash_attn_ext<FA_TYPES,    half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  48,  48, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk64_dv64_t16"  )]]  kernel flash_attn_ext_t16_t kernel_flash_attn_ext<FA_TYPES,    half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  64,  64, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk72_dv72_t16"  )]]  kernel flash_attn_ext_t16_t kernel_flash_attn_ext<FA_TYPES,    half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  72,  72, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk80_dv80_t16"  )]]  kernel flash_attn_ext_t16_t kernel_flash_attn_ext<FA_TYPES,    half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  80,  80, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk96_dv96_t16"  )]]  kernel flash_attn_ext_t16_t kernel_flash_attn_ext<FA_TYPES,    half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  96,  96, OP_FLASH_ATTN_EXT_NQPSG_16>;
...
// f16 Q + f16 KV, tile-16
typedef decltype(kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16, 64, 64, OP_FLASH_ATTN_EXT_NQPSG_16>) flash_attn_ext_f16q_t16_t;

template [[host_name("kernel_flash_attn_ext_f16_dk32_dv32_f16q_t16"  )]]  kernel flash_attn_ext_f16q_t16_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  32,  32, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk40_dv40_f16q_t16"  )]]  kernel flash_attn_ext_f16q_t16_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  40,  40, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk48_dv48_f16q_t16"  )]]  kernel flash_attn_ext_f16q_t16_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  48,  48, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk64_dv64_f16q_t16"  )]]  kernel flash_attn_ext_f16q_t16_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  64,  64, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk72_dv72_f16q_t16"  )]]  kernel flash_attn_ext_f16q_t16_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  72,  72, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk80_dv80_f16q_t16"  )]]  kernel flash_attn_ext_f16q_t16_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  80,  80, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk96_dv96_f16q_t16"  )]]  kernel flash_attn_ext_f16q_t16_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  96,  96, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk112_dv112_f16q_t16")]]  kernel flash_attn_ext_f16q_t16_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  112, 112, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk128_dv128_f16q_t16")]]  kernel flash_attn_ext_f16q_t16_t kernel_flash_attn_ext<FA_TYPES_F16Q, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  128, 128, OP_FLASH_ATTN_EXT_NQPSG_16>;
