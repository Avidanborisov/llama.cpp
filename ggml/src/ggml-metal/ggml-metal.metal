...
template [[host_name("kernel_flash_attn_ext_f16_dk72_dv72_q16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  72,  72, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk80_dv80_q16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  80,  80, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk96_dv96_q16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  96,  96, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk112_dv112_q16")]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16, 112, 112, OP_FLASH_ATTN_EXT_NQPSG_16>;
template [[host_name("kernel_flash_attn_ext_f16_dk128_dv128_q16")]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16, 128, 128, OP_FLASH_ATTN_EXT_NQPSG_16>;
