...
template [[host_name("kernel_flash_attn_ext_f16_dk32_dv32_nqptg16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  32,  32, OP_FLASH_ATTN_EXT_NQPSG_KV_REUSE>;
template [[host_name("kernel_flash_attn_ext_f16_dk40_dv40_nqptg16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  40,  40, OP_FLASH_ATTN_EXT_NQPSG_KV_REUSE>;
template [[host_name("kernel_flash_attn_ext_f16_dk48_dv48_nqptg16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  48,  48, OP_FLASH_ATTN_EXT_NQPSG_KV_REUSE>;
template [[host_name("kernel_flash_attn_ext_f16_dk64_dv64_nqptg16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  64,  64, OP_FLASH_ATTN_EXT_NQPSG_KV_REUSE>;
template [[host_name("kernel_flash_attn_ext_f16_dk72_dv72_nqptg16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  72,  72, OP_FLASH_ATTN_EXT_NQPSG_KV_REUSE>;
template [[host_name("kernel_flash_attn_ext_f16_dk80_dv80_nqptg16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  80,  80, OP_FLASH_ATTN_EXT_NQPSG_KV_REUSE>;
template [[host_name("kernel_flash_attn_ext_f16_dk96_dv96_nqptg16"  )]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  96,  96, OP_FLASH_ATTN_EXT_NQPSG_KV_REUSE>;
template [[host_name("kernel_flash_attn_ext_f16_dk112_dv112_nqptg16")]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  112, 112, OP_FLASH_ATTN_EXT_NQPSG_KV_REUSE>;
template [[host_name("kernel_flash_attn_ext_f16_dk128_dv128_nqptg16")]]  kernel flash_attn_ext_t kernel_flash_attn_ext<FA_TYPES, half4x4, 1, dequantize_f16, half4x4, 1, dequantize_f16,  128, 128, OP_FLASH_ATTN_EXT_NQPSG_KV_REUSE>;
